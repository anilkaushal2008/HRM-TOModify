...
public partial class tblGroupMaster
{
    ...
    public tblGroupMaster()
    {

        this.tblPermissionMaster = new HashSet<tblPermissionMaster>();
    ...
    public virtual ICollection<tblPermissionMaster> tblPermissionMaster { get; set; }
